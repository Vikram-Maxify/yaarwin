                        ...
                        <div data-v-a9660e98="" class="van-col van-col--6">
                            <div data-v-a9660e98="" class="goItem c-row c-tc c-row-center">
                                <div data-v-a9660e98="" class="c-tc c-row box c-row-center">
                                    <span data-v-a9660e98="" class="li ${list_orders.amount % 2 == 0 ? "red1" : "green1"}"></span>
                                    ${list_orders.amount == 0 || list_orders.amount == 5 ? '<span data-v-a9660e98="" class="li violet1"></span>' : ""}
                                </div>
                            </div>
                        </div>
                    </div>
...
socket.on("data-server", function (msg) {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            let is = ''
            if (typeid == '1') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx == '-1') ? 'Random' : response.setting[0].trx}`);
            if (typeid == '2') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx3 == '-1') ? 'Random' : response.setting[0].trx3}`);
            if (typeid == '3') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx5 == '-1') ? 'Random' : response.setting[0].trx5}`);
            if (typeid == '4') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx10 == '-1') ? 'Random' : response.setting[0].trx10}`);
...
$.ajax({
        ...
        success: function (response) {
            ...
            console.log('ddd',response.setting[0].trx3,typeid)
            $('.reservation-chunk-sub-num').text(response.lotterys[0].period);
            let is = ''
            if (typeid == '1') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx == '-1') ? 'Random' : response.setting[0].trx}`);
            if (typeid == '22') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx3 == '-1') ? 'Random' : response.setting[0].trx3}`);
            if (typeid == '33') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx5 == '-1') ? 'Random' : response.setting[0].trx5}`);
            if (typeid == '4') is = $('#ketQua').text(`Next Result: ${(response.setting[0].trx10 == '-1') ? 'Random' : response.setting[0].trx10}`);
