    ...
    <div className="p-2 flex flex-col items-center rounded ">
      ...
      <div className="w-full px-2 border-t border-[#D8EBE4]">
        <ul className="space-y-1">
          ...
          <li className="flex items-start gap-3">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#3ddc84] flex-shrink-0"></span>
            <p className="text-[#2b2b2b] text-[15px] leading-relaxed">
              YaarWin works with more than 10,000 online live game dealers and
          ...
          <li className="flex items-start gap-3">
            <span className="mt-2 w-1.5 h-1.5 rounded-full bg-[#3ddc84] flex-shrink-0"></span>
            <p className="text-[#2b2b2b] text-[15px] leading-relaxed">
              YaarWin supports fast deposit and withdrawal, and looks forward to
              your visit.
            </p>
          </li>
        </ul>
        ...
        <div className="mt-5 pl-5 space-y-1">
          ...
          <p className="text-[#5fd68a] text-[14px]">
            YaarWin only accepts customers above the age of 18.
          </p>
        </div>
      </div>
      ...
      {/* <div className="text-xs text-whites font-sm space-y-2 max-w-xl">
        ...
        <p className="flex items-start gap-1">
          ...
          in91 works with more than 10,000 online live game dealers and slot
        ...
        <p className="flex items-start gap-1">
          ...
          in91 supports fast deposit and withdrawal and looks forward to your
          visit.
        </p>
        <br />
        ...
        <p className="text-[#F5CC2C]">
          in91 only accepts customers above the age of 18.
        </p>
      </div> */}
    </div>
  );
